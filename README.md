...
- **City**: generate a whole medieval city from the panel and preview it in 3D before the server builds it: the whole city stands on a stone foundation with plank streets lined by low lantern fences; timber-and-stone ramparts with towers, gatehouses and a moat, main square and monument, a two-storey castle with its throne room and bedrooms, every crafting station with its upgrades, a foundry, Haldor, Hildir and the Bog Witch in a market, a great mead hall, an armory displaying every weapon and armor set of the game, the arena and Viking houses that are all different (two storeys, L and T shapes, balconies, gardens). New players spawn there. Walls and roofs are held by the server, so they never wear out, collapse or get destroyed; missing pieces are put back automatically.
