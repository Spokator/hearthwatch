...
- **Player portal**: a companion app for the phone. It follows the player through the city (position, district, inhabitants within earshot with their distance), shows Spokaheim in **3D** — terrain, walls, roofs, every inhabitant moving live, the sky lit by the game's own clock — and lets them tap an inhabitant to talk (free text, suggested choices, voice, hands-free) or tap the ground to drop a marker on their in-game map. The Emperor gets a throne room: treasury, tax dial, decrees, court, petitions, pardons, proclamations and an evening council written by his chancellor. Players type `!portal` in game, get a code and open the portal on their phone: character sheet, renown and titles, contracts with their progress, the saga, city news, the leaderboard and a directory of the inhabitants — including conversations with them from outside the game. With the optional voice service, each inhabitant speaks with their own voice and players can answer by talking.
...
- **Talking**: say a name in the chat, or simply walk up to someone. Inhabitants offer numbered choices — answer with a digit in game, or tap the same options as buttons on the portal. Mechanics are decided by the server (contracts, prices, deliveries, rewards) and the AI only gives the character their voice, in their mood, with their secrets. Chat commands: `!help`, `!journal`, `!saga`, `!work`, `!accept N`, `!turnin`, `!prices`, `!buy N item`, `!sell`, `!renown`, `!who`, `!rumours`, `!time`, `!fine`, `!portal`.
...
- **The Crown**: a player reigns as Emperor. An imperial tax on every reward fills a treasury; decrees (tax, feast, state of alert, market subsidy, amnesty, funding the works, paying the guard) change the city for days; the Emperor knights players, appoints a captain, a steward, a herald and a judge with real powers, answers petitions and proclaims through the herald. A discontent meter moves prices, colours what the inhabitants say, and pushes them to file grievances of their own.
