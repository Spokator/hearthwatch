...
- **City**: generate a whole medieval city from the panel and preview it in 3D before the server builds it: polygonal ramparts with towers and gates, main square and monument, palace, every crafting station with its upgrades, a foundry, Haldor, Hildir and the Bog Witch in a market, a tavern with free beds, the arena and dozens of houses. New players spawn there. Walls and roofs are held by the server, so they never wear out, collapse or get destroyed; missing pieces are put back automatically.
