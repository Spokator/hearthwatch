...
- **Portail des joueurs** : un compagnon pour le téléphone. Il suit le joueur dans la cité (position, quartier, habitants à portée de voix avec leur distance), montre Spokaheim **en 3D** — relief, remparts, toits, habitants qui bougent en direct, ciel éclairé par l'heure du jeu — et permet de toucher un habitant pour lui parler (texte libre, choix proposés, voix, mains libres) ou de toucher le sol pour poser un repère sur sa carte en jeu. L'Empereur y trouve sa salle du trône : trésor, curseur d'impôt, décrets, cour, doléances, grâces, proclamations et un conseil du soir écrit par sa chancelière. Le joueur tape `!portail` en jeu, reçoit un code et ouvre le portail sur son téléphone : feuille de personnage, renommée et titres, contrats et leur avancement, saga, nouvelles de la cité, classement et annuaire des habitants — avec qui il peut converser même hors du jeu. Avec le service vocal facultatif, chaque habitant parle de sa propre voix et le joueur peut répondre en parlant.
...
- **Parler** : dites un prénom dans le chat, ou approchez-vous simplement. Les habitants proposent des choix numérotés — répondez par un chiffre en jeu, ou touchez les mêmes boutons sur le portail. La mécanique est décidée par le serveur (contrats, prix, livraisons, récompenses) et l'IA ne fait que donner sa voix au personnage, avec son humeur et ses secrets. Commandes : `!aide`, `!journal`, `!saga`, `!contrats`, `!accepter N`, `!rendre`, `!prix`, `!acheter N objet`, `!vendre`, `!renommee`, `!qui`, `!rumeurs`, `!heure`, `!amende`, `!portail`.
...
- **La Couronne** : un joueur règne en Empereur. Une taxe impériale sur chaque récompense remplit un trésor ; les décrets (impôt, fête, état d'alerte, marché subventionné, amnistie, financement du chantier, solde de la garde) changent la cité pour plusieurs jours ; l'Empereur adoube, nomme un capitaine, un intendant, un héraut et un juge dotés de vrais pouvoirs, répond aux doléances et proclame par la voix du héraut. Un mécontentement mesuré fait bouger les prix, colore ce que disent les habitants, et les pousse à déposer eux-mêmes des doléances.
